...
<body>
    ...
    <div class="contain">
        ...
        <form action="" method="POST" class="fill-form" autocomplete="off">
            ...
            <div class="email"><br>
                <p>Enter E-mail or Username</p>
                <input type="text" name="usernameemail"  id="usernameemail" class="form-contrl2" placeholder="E-mail*" required value=""><br>
            </div>
        ...
        <div class="sign_in">
            <a href="registration.php">If You Can't Sign up? Sign up</a>
        </div>
