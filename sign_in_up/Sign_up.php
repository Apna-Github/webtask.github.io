...
<body>
    ...
    <div class="contain">
        ...
        <form action="" method="POST" class="fill-form" autocomplete="off">
            ...
            <div class="name"><br>
                <p>Enter Full Name</p>
                <input type="text" name="name" id="name" class="form-contrl1" placeholder="Full Name*" required>
            </div>

            <div class="username"><br>
                <p>Username</p>
                <input type="text" name="username" id="username" class="form-contrl3" required placeholder="username">
            </div>

            <div class="email"><br>
                <p>Enter E-mail</p>
                <input type="email" name="email"  id="email" class="form-contrl2" placeholder="E-mail*" required>
            </div>
            ...
            <div class="confirmpassword">
                ...
                <input type="password" name="confirmpassword" id="confirmpassword" class="form-contrl4" required placeholder="Confirm password">
            </div>
