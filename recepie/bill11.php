...
<div class="food_menu">
    <div class="image-buttons">
        <div class="menu_col">
            <img src="../recepie/image/lassi.jpeg" alt="Special_Lassi" data-price="30" onclick="toggleSelection('Special_Lassi', 30)">
            <h2>$30</h2>
            <p>Special_Lassi</p>
        </div>
        <div class="menu_col">
            <img src="../recepie/image/lassi1.jpeg" alt="mastani_Lassi" data-price="40" onclick="toggleSelection('mastani_Lassi', 40)">
            <h2>$40</h2>
            <p>mastani_Lassi</p>
        </div>
        <div class="menu_col">
            <img src="../recepie/image/lassi2.jpeg" alt="Strobery_Lassi" data-price="35" onclick="toggleSelection('Strobery_Lassi', 35)">
            <h2>$35</h2>
            <p>Strobery_Lassi</p>
        </div>
        <div class="menu_col">
            <img src="../recepie/image/lassi3.jpeg" alt="Almonds_Lassi" data-price="45" onclick="toggleSelection('Almonds_Lassi', 45)">
            <h2>$45</h2>
            <p>Almonds_Lassi</p>
        </div>
        <div class="menu_col">
            <img src="../recepie/image/lassi4.jpeg" alt="Kullad_Lassi" data-price="20" onclick="toggleSelection('Kullad_Lassi', 20)">
            <h2>$20</h2>
            <p>Kullad_Lassi</p>
        </div>
    </div>
