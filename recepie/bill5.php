...
<div class="food_menu">
    <div class="image-buttons">
        <div class="menu_col">
            <img src="../recepie/image/tea.jpeg" alt="Green_Tea" data-price="40" onclick="toggleSelection('Green_Tea', 40)">
            <h2>$40</h2>
            <p>Green_Tea</p>
        </div>
        <div class="menu_col">
            <img src="../recepie/image/tea1.jpeg" alt="Black_Tea" data-price="20" onclick="toggleSelection('Black_Tea', 20)">
            <h2>$20</h2>
            <p>Black_Tea</p>
        </div>
        <div class="menu_col">
            <img src="../recepie/image/tea2.jpeg" alt="Golden_Tea" data-price="25" onclick="toggleSelection('Golden_Tea', 25)">
            <h2>$25</h2>
            <p>Golden_Tea</p>
        </div>
        <div class="menu_col">
            <img src="../recepie/image/tea3.jpeg" alt="Special_Tea" data-price="15" onclick="toggleSelection('Special_Tea', 15)">
            <h2>$15</h2>
            <p>Special_Tea</p>
        </div>
        <div class="menu_col">
            <img src="../recepie/image/tea6.jpeg" alt="kullad_Tea" data-price="30" onclick="toggleSelection('kullad_Tea', 30)">
            <h2>$30</h2>
            <p>kullad_Tea</p>
        </div>
    </div>
