...
<div class="food_menu">
    <div class="image-buttons">
        <div class="menu_col">
            <img src="../recepie/image/juice.jpeg" alt="Orange_Juice" data-price="30" onclick="toggleSelection('Orange_Juice', 30)">
            <h2>$30</h2>
            <p>Orange_Juice</p>
        </div>
        <div class="menu_col">
            <img src="../recepie/image/juice1.jpeg" alt="Karela_Juice" data-price="25" onclick="toggleSelection('Karela_Juice', 25)">
            <h2>$25</h2>
            <p>Karela_Juice</p>
        </div>
        <div class="menu_col">
            <img src="../recepie/image/juice2.jpeg" alt="Lemon_Juice" data-price="10" onclick="toggleSelection('Lemon_Juice', 10)">
            <h2>$10</h2>
            <p>Lemon_Juice</p>
        </div>
        <div class="menu_col">
            <img src="../recepie/image/juice3.jpeg" alt="Stroberry_Juice" data-price="40" onclick="toggleSelection('Stroberry_Juice', 40)">
            <h2>$40</h2>
            <p>Stroberry_Juice</p>
        </div>
        <div class="menu_col">
            <img src="../recepie/image/juice4.jpeg" alt="WaterLemon_Juice" data-price="30" onclick="toggleSelection('WaterLemon_Juice', 30)">
            <h2>$30</h2>
            <p>WaterLemon_Juice</p>
        </div>
    </div>
</div>
